...
Labels = {'Encoder 1 Velocity','Encoder 1 Position','Encoder 2 Velocity','Encoder 2 Position'};
...
figure(1)
plot(data(:,1), data(:,2),'g', data(:,1), data(:,3),'b', data(:,1), data(:,4),'r', data(:,1), data(:,5),'m'); 
title('Serial Data')
xlabel('Time (sec)'),ylabel('Values'), grid
legend(Labels);
